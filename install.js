...
module.exports.getManifest = function(mods, fullScan, emuPath, checkFiles) {
    ...
    if (fullScan || emuPath && !fs.existsSync(path.join(emuPath, "swgemu.cfg"))) {
        ...
        files = files.concat([
            {name:"swgemu.cfg", size:131, md5:"7965b1bbd4991e3e6f3932a00f61171c", url:"http://ode-guild.com/swg/updates/swgemu.cfg"},
            {name:"swgemu_machineoptions.iff", size:6552, md5:"ea4030a8cf303eb71a376990497b1019", url:"http://ode-guild.com/swg/updates/swgemu_machineoptions.iff"},
            {name:"swgemu_preload.cfg", size:2018, md5:"0afeddc346edfb136bf55315f002f45a", url:"http://ode-guild.com/swg/updates/swgemu_preload.cfg"}
        ]);
    }
